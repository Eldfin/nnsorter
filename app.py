...
if not GOOGLE_API_KEY:
    st.error("GOOGLE_API_KEY fehlt! Bitte als Streamlit Secret oder Environment-Variable setzen.")
    st.stop()
...
if st.session_state['camera_image']:
    data_url = st.session_state['camera_image']
